...
def sanitize_text(text):
    ...
    replacements = {
        ...
        "熟女": ["大人女性", "成熟した女性", "落ち着いた雰囲気の女性", "経験を感じる女性"],
        "巨乳": ["グラマラスな魅力", "華やかな上半身", "存在感のあるスタイル", "ボリューム感のあるスタイル"],
        "爆乳": ["圧倒的な存在感", "華やかな上半身", "インパクトの強いスタイル"],
        ...
        "エロ": ["魅力", "見どころ", "作品性"],
        "エッチ": ["親密さ", "距離感", "関係性"],
        "セックス": ["距離感の近い場面", "親密なシーン", "関係性を描く場面"],
        "SEX": ["距離感の近い場面", "親密なシーン", "関係性を描く場面"],
        "中出し": ["終盤の見どころ", "締めくくりの演出", "ラストの見せ場"],
        "生中出し": ["終盤の見どころ", "締めくくりの演出", "ラストの見せ場"],
