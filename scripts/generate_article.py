...
def sanitize_text(text):
    ...
    text = str(text)
    rng = random.Random(abs(hash(text)))

    replacements = {
        "人妻": ["既婚女性", "大人の女性", "落ち着いた女性", "成熟した女性", "生活感のある女性像"],
        "熟女": ["大人女性", "成熟した女性", "経験を感じる女性"],
        "巨乳": ["グラマラスな魅力", "華やかな上半身", "存在感のある上半身", "ボリューム感のあるスタイル"],
        "爆乳": ["圧倒的な上半身", "華やかな上半身", "インパクトの強い体型"],
        "巨尻": ["下半身の存在感", "メリハリのあるスタイル", "存在感のあるシルエット"],
        "アダルト": ["A⚫︎作品", "A⚫︎作品", "A⚫︎コンテンツ"],
        "エロ": ["魅力", "見どころ"],
        "エッチ": ["交わり", "距離感", "関係性"],
        "セックス": ["距離感の近い場面", "濃密なシーン", "関係性を描く場面"],
        "SEX": ["距離感の近い場面", "親密なシーン", "関係性を描く場面"],
        "中出し": ["フィニッシュ", "締めくくりの演出", "ラストの見せ場"],
        "生中出し": ["⚫︎出しフィニッシュ", "締めくくりの演出", "ラストの見せ場"],
        "フェラ": ["印象的な見せ場", "距離感の近い演出", "サービスシーン"],
        "顔射": ["終盤の演出", "印象的な締めくくり", "インパクトのある演出"],
        "射精": ["終盤の演出", "クライマックス", "締めくくりの場面"],
        "精子": ["終盤の演出", "クライマックス演出"],
        "ザーメン": ["終盤の演出", "クライマックス演出"],
        "挿入": ["見せ場", "展開の中心", "重要なシーン"],
        "喘ぎ": ["感情表現", "リアクション", "表情の豊かさ"],
        "潮吹き": ["リアクション重視", "感情表現が目立つ場面"],
        "ハメ撮り": ["主観演出", "距離感の近い演出", "視点重視の構成"],
        "NTR": ["関係性重視の設定", "ドラマ性の強い設定", "心理描写重視の設定"],
        "不倫": ["背徳感のある設定", "関係性重視の設定", "ドラマ性のある展開"],
        "痴女": ["積極的な女性", "主導的な女性", "存在感のある女性"],
        "盗撮": ["ドキュメント風演出", "観察視点の構成"],
        "のぞき": ["観察視点の演出", "ドキュメント風構成"],
        "露出": ["開放感のあるシチュエーション", "ロケーション重視"],
        "野外": ["屋外シチュエーション", "ロケーション重視"],
        "風俗": ["非日常的な設定", "コンセプト重視の作品"],
        "ラブホ": ["プライベート空間", "室内シーン"],
        "調教": ["強めの展開", "刺激重視の構成"],
        "レイプ": ["強制系", "ハードな設定"],
        "凌辱": ["強制系", "ハードな設定"],
